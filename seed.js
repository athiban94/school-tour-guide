...
const main = async () => {
  ...
  const restraunt2 = await restraunts.addRestaurant({
    ...
    description: "Pierce Dining Hall is the central dining hall for the Stevens Dining Program. Focused on fresh, quality food served in a relaxing dining atmosphere, Pierce Dining Hall not only offers some of the finest foods in college dining but easily one of the best views.",
    address: "Wesley J. Howe Center, 2nd Floor",
    comments: []
  ...
  const restraunt3 = await restraunts.addRestaurant({
    ...
    description: "In addition to the everyday convenience of Grab & Go and Starbucks Proudly Brew Coffee, Red & Gray features a local New Jersey built franchise Green Zebra. Green Zebra offers an assortment of freshly made wraps and salads featuring homemade organic dressings.",
  ...
  const restraunt4 = await restraunts.addRestaurant({
    ...
    description: "Stevens' modern coffee house features the Starbucks Proudly Brew program, along with local favorite Bagel Smashery. And at crEATe, you can customize salads, wraps and sandwich the way you want it, right in front of your eyes!",
  ...
  const restraunt5 = await restraunts.addRestaurant({
    ...
    description: "Colonel John's features two dining experiences. Asian Express a fast, fresh and flavorful quick serve concept based on traditional Asian cuisine and Grill Nation, a customizable burger menu offering a long list of premium ingredients, allowing for numerous combinations.",
    address: "Wesley J. Howe Center, 1st Floor",
    comments: []

  });
  let adminPassword = "stevens2018";
